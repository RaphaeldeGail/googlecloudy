...
DOCUMENTATION = '''
---
module: gcp_resourcemanager_tagkey_iam_info
description:
- Gets the access control policy for a tagKey.
- The caller must have cloudresourcemanager.googleapis.com/tagKeys.getIamPolicy permission on the specified TagKey.
short_description: Gets the access control policy for a tagKey
...
EXAMPLES = '''
- name: Gets the access control policy for a tagKey
