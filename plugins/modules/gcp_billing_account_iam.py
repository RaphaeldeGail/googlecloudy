...
def main():
    ...
    fetch = fetch_resource(module, f'{self_link(module)}:getIamPolicy', False)
    changed = False
...
def set(module, link):
    ...
    return return_if_object(module, auth.post(f'{link}:setIamPolicy', resource_to_request(module)))
