...
DOCUMENTATION = '''
---
module: gcp_resourcemanager_project_iam
description:
- Sets the access control policy for a project.
short_description: Sets the access control policy for a GCP project
...
EXAMPLES = '''
- name: Sets the access control policy for a GCP project
