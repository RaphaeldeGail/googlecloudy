...
DOCUMENTATION = '''
---
module: gcp_resourcemanager_folder_iam_info
description:
...
short_description: Gets the access control policy for a GCP folder
...
EXAMPLES = '''
- name: Gets the access control policy for a GCP folder
  raphaeldegail.googlecloudy.gcp_resourcemanager_folder_iam_info:
    folder_id: 1234
